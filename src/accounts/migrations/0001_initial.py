    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cv', models.FileField(blank=True, null=True, upload_to='cvs',
                                        validators=[
                                            django.core.validators.FileExtensionValidator(
                                                ['pdf', 'docx', 'doc'])],
                                        verbose_name='Резюме')),
                ('remote', models.PositiveSmallIntegerField(blank=True,
                                                            choices=[(None,
                                                                      'Не указывать'),
                                                                     (1,
                                                                      'Онлайн'),
                ...
                ('is_male', models.BooleanField(blank=True, choices=[
                    (None, 'Не указывать'), (True, 'Мужской'),
                    (False, 'Женский')], default=None, null=True,
                                                verbose_name='Пол')),
                ...
                ('belbin',
                 models.ManyToManyField(blank=True, related_name='profiles',
                                        to='tests.BelbinTest',
                ...
                ('specialization', models.ManyToManyField(blank=True,
